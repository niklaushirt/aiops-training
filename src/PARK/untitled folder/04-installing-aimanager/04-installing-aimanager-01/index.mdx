...
## 🚀 TASK: Create the CP4WAIOPS Instance" link="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.5.0?topic=manager-starter-installation-cli" >}}
...
<InlineNotification kind="warning">  title="Warning" >}}
...
<InlineNotification kind="error"> title="Warning" >}}
...
<InlineNotification kind="info"> title="Note" >}}
