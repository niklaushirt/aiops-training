...
- Integrate AIManager with `Instana` (optional)
...
<Accordion>
<AccordionItem title="Installing the Operator">
...
<Accordion>
<AccordionItem title="Installing AIManager">
...
<Accordion>
<AccordionItem title="Installing Training Resources">
...
<Accordion>
<AccordionItem title="Configure AIManager">
...
<Accordion>
<AccordionItem title="Train the AI Models">
...
<Accordion>
<AccordionItem title="Test And Demo">
...
<Accordion>
<AccordionItem title="Integrate with Instana">

In this chapter you will integrate AIManager with `Instana`

</AccordionItem>
</Accordion>

<Accordion>
<AccordionItem title="Integrate with Slack">
...
<Accordion>
<AccordionItem title="Integrate with Service Now">

In this chapter you will integrate AIManager with `Service Now`
