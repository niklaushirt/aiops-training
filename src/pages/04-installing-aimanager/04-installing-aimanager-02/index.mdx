---
title: "Check AIManager Installation"
---


## 🚀 TASK: Verify that the AIManager Installation is ready
[Official Documentation](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.5.0?topic=manager-starter-installation-cli)
