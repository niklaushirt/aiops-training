...
## 🚀 TASK: Integrate Instana with AIManager

[Official Documentation](https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.5.1?topic=connections-instana)
