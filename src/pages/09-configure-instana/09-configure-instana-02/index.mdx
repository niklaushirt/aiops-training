...
## 🚀 TASK: Create RobotShop Application

<a href="https://www.ibm.com/docs/en/instana-observability/current?topic=capabilities-application-perspectives" target="_blank" >🌏 Documentation for the Task</a>
